...
import { Calendar, Clock, ChevronLeft, BookOpen, Home, Mail, Linkedin, Github } from 'lucide-react';
  ...
  <footer className="bg-slate-950 py-12 border-t border-slate-900 mt-auto">
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
      ...
      <div className="flex justify-center gap-8 mb-8">
        <a href="mailto:acsureja@gmail.com" target="_blank" rel="noopener noreferrer" className="text-slate-400 hover:text-white transition-colors">
          <Mail size={24} />
        </a>
        <a href="https://linkedin.com/in/architsureja" target="_blank" rel="noopener noreferrer" className="text-slate-400 hover:text-white transition-colors">
          <Linkedin size={24} />
        </a>
        <a href="https://architsureja.github.io" target="_blank" rel="noopener noreferrer" className="text-slate-400 hover:text-white transition-colors">
          <Github size={24} />
        </a>
      </div>
          ...
          <div className="flex justify-between items-center mb-16">
            <div className="text-left">
              <h2 className="text-3xl font-bold text-white mb-2 flex items-center gap-3">
                <BookOpen className="text-blue-500" /> Technical Blog
              </h2>
              <p className="text-slate-400 max-w-2xl">
                Deep dives into system design, artificial intelligence, and software architecture.
              </p>
            </div>
